          ...
          <div className="border-color-100 w-full overflow-hidden ">
            <div className="scroll-containers animate-infinite-scroll flex w-max gap-[21px]">
              <div className="flex gap-[21px]">
                <Image height={163} width={463} src="/donors/Frame 1618874193.png" alt="" />
                <Image height={163} width={463} src="/donors/Frame 1618874194.png" alt="" />
                <Image height={163} width={463} src="/donors/Frame 1618874195.png" alt="" />
                <Image height={163} width={463} src="/donors/Frame 1618874196.png" alt="" />
              </div>
